...
public class Vendedor extends Pessoa {
	...
	public void calcularSalario() {
		double totalSalario =  this.getSalario() + (this.getValorVendas() * (this.getComissao())/100);
		System.out.println("O total do salário do(a) '"+this.getNome()+"' é "+totalSalario+"Reais");
	}
}
